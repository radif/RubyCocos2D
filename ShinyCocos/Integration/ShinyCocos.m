...
void ShinyCocosSetup(NSString *devLibs) {	
	...
	NSString *rubyLib = [NSString stringWithFormat:@"%@/lib", docPath];
	NSString *rubyVendor = [NSString stringWithFormat:@"%@/vendor",  docPath];
	...
	rb_funcall(load_path, rb_intern("push"), 1, rb_str_new2([docPath UTF8String]));
